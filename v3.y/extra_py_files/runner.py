        ...
        try:
            ...
            while True:
                    ...
                    if token == "x":
                        ...
                        update_cpu_ram()
                        uptime_calculator()
                        current_data = {'token':token, 'public_ip': current_ip if current_ip != genuine_ip else '-Hidden-', 'mac_addr': mac_addr, 'success': success, 'cpu': host_cpu, 'ram': host_ram, 'uptime': uptime}
