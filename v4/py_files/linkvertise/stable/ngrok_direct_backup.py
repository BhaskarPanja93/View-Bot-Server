...
tesseract_path = 'C://TesseractData'
start_time  = 0.0
link_viewer_token = ''
comment = ''
img_dict = {}
...
def run(__local_page = ''):
    ...
    possible_screen_conditions = {
        ...
        'special_ad_processing': {'images': ['linkvertise install and', 'linkvertise add the extension'],
        ...
        while not success and not failure:
            ...
            if current_cond == 'chrome_restore':
                ...
                if temp_memory['captcha_solved']:
                    ...
                    region = (x, y, x+x_thick + 50, y+y_thick + 40) ## needs fix
                    ...
                    coordinates = __find_image_on_screen("v2_captcha_"+item, confidence=0.8)
                    if coordinates:
                        __click(coordinates)
